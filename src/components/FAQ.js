    ...
    <section id="faq" className="py-20 px-6 text-white">
      <div className="max-w-3xl mx-auto">
        <div className="flex flex-col gap-6 mb-12 text-center">
          <h2 className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#E61933] to-[#FF33CC] font-['Inter']">FAQ</h2>
        ...
        <div className="flex flex-col gap-4">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                {faq.question}
                <span className="flex items-center text-[#E61933]">
        ...
        <div className="mt-12 text-center">
          <p className="text-[#a3a3a3]">Still have questions? Email us at <a href="mailto:contact@hackaccino.in" className="text-[#E61933] no-underline hover:underline">contact@hackaccino.in</a></p>
        </div>
      </div>
    </section>
  );
