      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 items-start text-center md:text-left">
        ...
        <div className="flex flex-col gap-10 md:pl-10 items-center md:items-start">
          <div>
            ...
            <a href="mailto:contact@hackaccino.in" className="flex items-center gap-3 text-gray-400 no-underline transition-colors duration-200 bg-[#111] py-2.5 px-4 rounded-lg w-fit border border-[#222] hover:text-white hover:border-[#333] hover:bg-[#1a1a1a] mx-auto md:mx-0">
