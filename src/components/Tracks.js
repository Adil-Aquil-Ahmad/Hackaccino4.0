  ...
  const tracks = [
    {
      ...
      icon: <FaRobot size={24} color="#E61933" className="animate-pulse-slow" />
    },
    {
      title: "Cloud",
      ...
      icon: <FaCloud size={24} color="#E61933" className="animate-pulse-slow" />
    },
    {
      title: "AR/VR",
      ...
      icon: <FaVrCardboard size={24} color="#E61933" className="animate-pulse-slow" />
    },
    {
      title: "IoT",
      ...
      icon: <FaMicrochip size={24} color="#E61933" className="animate-pulse-slow" />
    },
    {
      title: "Web3",
      ...
      icon: <FaLink size={24} color="#E61933" className="animate-pulse-slow" />
    },
    {
      title: "Open Innovation",
      description: "Propose and build innovative solutions to real-life challenges using any technology of your choice.",
      icon: <FaLightbulb size={24} color="#E61933" className="animate-pulse-slow" />
    }
  ];
    ...
    <section id="tracks" className="text-white py-20 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col gap-6 mb-8">
          <h2 className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#E61933] to-[#FF33CC] font-['Inter']">Tracks</h2>
          ...
          {tracks.map((track, index) => (
            <div key={index} className="group relative p-6 rounded-xl backdrop-blur-md bg-white/5 border border-white/10 cursor-pointer transition-all duration-300 hover:-translate-y-2.5 hover:scale-[1.02] hover:bg-white/10 hover:border-white/30 hover:shadow-[0_15px_40px_rgba(0,0,0,0.2)] overflow-hidden">
              <div className="flex flex-col gap-4 relative z-10">
                <div className="w-12 h-12 rounded-lg bg-[#E61933]/10 flex items-center justify-center transition-transform duration-300 group-hover:scale-110 group-hover:rotate-[5deg]">
                  {track.icon}
                </div>
                <h3 className="text-[#E61933] text-xl font-semibold">{track.title}</h3>
